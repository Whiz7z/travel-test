...
const HighlightsLineSvg = ({ h, lineHeight }) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M9.96412 14.875C11.3762 14.2566 12.5066 13.1262 13.125 11.7141C13.7434 13.1262 14.8738 14.2566 16.2859 14.875C14.8738 15.4934 13.7434 16.6238 13.125 18.0359C12.5066 16.6238 11.3762 15.4934 9.96412 14.875Z"
        stroke="white"
        strokeWidth="1.25"
      />
      <path
        d="M17.3949 8.5257C17.4178 8.41078 17.5822 8.41078 17.6051 8.5257C17.7938 9.46893 18.5311 10.2062 19.4743 10.3949C19.5892 10.4178 19.5892 10.5822 19.4743 10.6051C18.5311 10.7938 17.7938 11.5311 17.6051 12.4743C17.5822 12.5892 17.4178 12.5892 17.3949 12.4743C17.2062 11.5311 16.4689 10.7938 15.5257 10.6051C15.4108 10.5822 15.4108 10.4178 15.5257 10.3949C16.4689 10.2062 17.2062 9.46893 17.3949 8.5257Z"
        fill="white"
      />
    </svg>
  );
